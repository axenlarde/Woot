...
package com.cisco.axlapiservice8;
...
import com.cisco.axl.api._8.GetPhoneTypeDisplayInstanceReq;
import com.cisco.axl.api._8.GetPhoneTypeDisplayInstanceRes;
...
public interface AXLPort {
     ...
     * @param axlParams
     * @return
     *     returns com.cisco.axl.api._8.GetPhoneTypeDisplayInstanceRes
     */
    @WebMethod(action = "CUCM:DB ver=8.5 getPhoneTypeDisplayInstance")
    @WebResult(name = "getPhoneTypeDisplayInstanceResponse", targetNamespace = "http://www.cisco.com/AXL/API/8.5", partName = "axlParams")
    public GetPhoneTypeDisplayInstanceRes getPhoneTypeDisplayInstance(
        @WebParam(name = "getPhoneTypeDisplayInstance", targetNamespace = "http://www.cisco.com/AXL/API/8.5", partName = "axlParams")
